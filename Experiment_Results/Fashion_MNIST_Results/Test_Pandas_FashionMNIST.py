...
def plot_3D_surface(df):
    ...
    ax.set_title('Accuracy Score with ' + label_per_class + ' labeled data in Fashion-MNIST')
...
def plot_contour_surface(df):
    ...
    ax.set_xlabel('Spectral Cutoff N', fontweight ='bold')
    ax.set_ylabel('Laplacian Order m', fontweight ='bold')
    ax.set_title('Contour Map of Accuracy Score with ' + label_per_class + ' labeled data in Fashion-MNIST')
